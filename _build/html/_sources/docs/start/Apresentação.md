...
Para a comunicação assíncrona, e assim que disponibilizado pelos Serviços de Informática,  vamos usar o [Teams](). Para além do canal geral da [equipa](), teremos os canais das aulas [teóricas]() e dos turnos CGr-PL1 (turmas A e C) e CGr-PL2 (Turma B).
